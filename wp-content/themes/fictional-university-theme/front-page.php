...
<div class="full-width-split group">
  <!-- white From our event section -->
  <div class="full-width-split__one">
    <div class="full-width-split__inner">
      <h2 class="headline headline--small-plus t-center">Upcoming Events</h2>

      <?php 
      //this helps only showing events that dates havent passed yet 
        $today = date('Ymd');
  ...
  <div class="full-width-split__two">
    <div class="full-width-split__inner">
      ...
      <?php } 
      // this is used to clean up custom queries and set back to normal always apply if using a  custom queries
      wp_reset_postdata();
      ?>
